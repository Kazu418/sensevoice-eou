...
`architecture.webp` — the figure used at the top of the README. Everything in it was measured
...
| totals | 234 M params — int8 ≈ 228 MB, fp32 ≈ 895 MB; turn head 2048×1 + bias ≈ 9 KB |
